...
Code entirely copied from the Swerlein paper, 1980 and converted to python.
"""
...
class Algorithm(stuff.SwerleinThread):
    ...
    def __init__(self,**kwargs):
        ...
        #default settings
        self.info = {'port':24,'harmonics' :6,'name':None,'bursts':6,'readings':1,'time':15,'rng':'AUTO','acdc':True,'ac':False,'mean':False,'time':15,'grid':'','LFREQ':False}
        ...
        self.ready = False #ready flag, turns true once its done running.
